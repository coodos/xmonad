...
myStartupHook = do
    ...
    spawnOnce "dunst &"
    spawnOnce "nm-applet &"
    spawnOnce "xset m 1/1 0"
    spawnOnce "volumeicon &"
    spawnOnce "conky -c $HOME/.config/conky/xmonad.conkyrc"
    spawnOnce "xsetwacom set \"Wacom One by Wacom S Pen stylus\" MapToOutput HDMI-A-0"
    spawnOnce "trayer --edge top --align right --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent true --alpha 0 --tint 0x1d1d1d  --height 22 &"
...
myWorkspaces = [" dev ", " www ", " sys ", " doc ", " fun ", " chat ", " mus ", " vid ", " gfx "]
