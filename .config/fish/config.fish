...
# THEME PURE #
set fish_function_path /home/merul/.config/fish/functions/theme-pure/functions/ $fish_function_path
source /home/merul/.config/fish/functions/theme-pure/conf.d/pure.fish
